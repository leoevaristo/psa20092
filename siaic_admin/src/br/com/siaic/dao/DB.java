...
/**
 * Inicializa o drive do mySQL e abre uma conex�o com o banco.
 * 
...
public class DB {
	...
	/**
	 * Pega uma conex�o aberta com o banco de dados. Evita que o drive do mySQL
	 * seja carregado mais de uma vez. Evita que mais de uma conex�o com a base
	 * de dados seja aberta.
	 * 
	 * @return {@link Connection} (conex�o) aberta com o banco de dados.
	 * @throws SQLException
	 */
