...
*/
	...
	public Usuario getUsuarioId(int usuarioCodigo) throws SQLException
	{
		...
		String sql = "SELECT pu.PEU_CODIGO, pu.PEU_CRECI, pu.PEU_LOGIN, pu.PEU_SENHA , pe.PES_CODIGO, " 
			+"pe.PES_NOME, pe.PES_EMAIL, pe.PES_TELEFONE, pe.PES_CELULAR, pe.PES_ENDERECO, pe.PES_TIPO, pe.PES_SEXO, e.END_LOGRADOURO "
			+"FROM PESSOA_USUARIOS pu , PESSOA pe, ENDERECO e " 
