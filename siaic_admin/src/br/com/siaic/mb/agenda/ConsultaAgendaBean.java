...
/**
 * Classe para manipular todos dados referentes a exibição, alteração e
 * exclusão dos dados de uma Agenda
 * 
 * @author carlos
 * 
 */
public class ConsultaAgendaBean {
	...
	/**
	 * Retorna uma Lista de todas as entradas de Agenda existentes
	 * 
	 * @return List<Agenda>
	 * @throws SQLException
	 */
	...
	/**
	 * Busca os dados dos imóveis que pertencem a uma entrada da Agenda
	 * 
	 * @throws SQLException
	 */
	...
	/**
	 * Adiciona dados dos imóveis pertecentes à uma entrada da Agenda a um
	 * objeto do tipo Map
	 * 
	 * @return Map
	 */
	...
	public Map addDadosImoveis() {
		...
		dadosImoveis.put("bairroEnd", getEndereco().getEnderecoBairro()
				.getBairroNome());
		dadosImoveis.put("temPiscina", getImovelCaracteristica().getPiscina());
		dadosImoveis.put("numQuartos", getImovelCaracteristica()
				.getQtdeDormitorio());
		dadosImoveis.put("numSuite", getImovelCaracteristica().getQtdeSuite());
		dadosImoveis.put("numVagaGaragem", getImovelCaracteristica()
				.getQtdeGaragem());
